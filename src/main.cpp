...
class HelloTriangleApplication {
   ...
   private:
    ...
    void createGraphicsPipeline() {
        // TODO: add vertex input. it's hard coded on the shader for now
        ...
        std::cout << "Vertex input created successfully" << std::endl;

        auto vertexShaderCode = readFileIntoBuffer("shaders/vertex_shader.spv");
        std::cout << vertexShaderCode.size() << " bytes read from vertex shader" << std::endl;
        ...
        auto fragmentShaderCode = readFileIntoBuffer("shaders/fragment_shader.spv");
        std::cout << fragmentShaderCode.size() << " bytes read from fragment shader" << std::endl;
        ...
        std::cout << "Dynamic state created successfully" << std::endl;

        VkPipelineInputAssemblyStateCreateInfo inputAssembly{};
        inputAssembly.sType = VK_STRUCTURE_TYPE_PIPELINE_INPUT_ASSEMBLY_STATE_CREATE_INFO;
        inputAssembly.topology = VK_PRIMITIVE_TOPOLOGY_TRIANGLE_LIST;
        inputAssembly.primitiveRestartEnable = VK_FALSE;
        std::cout << "Input assembly created successfully" << std::endl;
        ...
        std::cout << "Viewport state created successfully" << std::endl;
    ...
    void recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
        ...
        VkClearValue clearColor = {{{1.0f, 1.0f, 1.0f, 0.5f}}};
